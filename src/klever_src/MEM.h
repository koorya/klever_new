//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//
//  Конфигурация зоны энергонезависимых регистров (Backup Domain Control Registers = BDCR)
//  и FLASH-памяти микроконтроллера STM32F10xxxx
//
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

#ifndef MEM_H	// Блокирую повторное включение этого модуля
#define MEM_H
...
//#define BDCR_Lock() (PWR->CR &= ~PWR_CR_DBP)
//#define BDCR_UnLock() (PWR->CR |= PWR_CR_DBP)
